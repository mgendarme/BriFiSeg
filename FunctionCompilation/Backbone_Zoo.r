...
# return(DEFAULT_ENCODER_LAYER)
# library(tensorflow)
# library(keras)
# testmod = tf$keras$applications$densenet$DenseNet121(input_shape = c(512L, 512L, 3L), include_top = FALSE)
# sink("~/Desktop/densenet169.txt")
# summary(testmod)
# sink()
