...
# x <- tf$constant(1:15, shape = c(3L, 5L))
# sess$run(x)

# test = sess$run(input_tensor[NULL,,,1:3])
# tf$slice()
# test = slice_tensor(input_tensor, 2, 3, axis = -1)    
...
# setest = SEResNeXt101(input_shape =  c(512, 512, 3))
