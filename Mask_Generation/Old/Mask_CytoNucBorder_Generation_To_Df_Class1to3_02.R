...
ImageProcessingAndEncoding <- function(Image, Plate, Well, Position){
  ...
  ## Export encoding
  write_csv(n_sample_out_nuc, paste0(UnetTrain_dir,"Plate_", Plate, "--Well_", Well, "--Position_", Position,"--n_sample_out_nuc_noBorderDiamond11_thickness11.csv"))
  write_csv(n_sample_out_cyto, paste0(UnetTrain_dir,"Plate_", Plate, "--Well_", Well, "--Position_", Position,"--n_sample_out_cyto_noBorderDiamond11_thickness11.csv"))
