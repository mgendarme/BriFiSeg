  ...
  # Settings#############################################################################################################################################
  Unet_dir <- ifelse(grepl("Windows", sessionInfo()$running), "~/BFSeg/BF_Data/BF_PH_20200207", "~/Documents/BFSeg/BF_Data/BF_PH_20200207")
  Train_dir <- ifelse(grepl("Windows", sessionInfo()$running), "~/BFSeg/BF_Data/BF_PH_20200207/Train", "~/Documents/BFSeg/BF_Data/BF_PH_20200207/Train")
