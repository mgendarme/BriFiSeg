...
pred_folder = paste0(nnunetpath, "/nnUNet_trained_models/nnUNet/2d/Task00", TASK, "_A549/nnUNetTrainerV2_unet_noDeepSupervision_sn__nnUNetPlansv2.1/fold_")
...
for(i in 0:4){
    ...
    # # display one representative image if necessary
    ...
    # source(paste0(RelPath, "/Scripts/FunctionCompilation/DICE_single_nnunet.r")) # for cca?
