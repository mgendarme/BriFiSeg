...
# json_train
json_train = list()
for(i in 0:(length(train_input_img)-1)){
...
## for preprocessing run in terminal
#########################################################################################################
### nnUNet_plan_and_preprocess -t 136 -pl3d None -pl2d ExperimentPlanner2D_v21_RGB_nonorm -tl 4 -tf 2 ###
#########################################################################################################
