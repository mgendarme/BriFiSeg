...
ZSTACK = 4
source(paste0(Unet_script_dir,"/nnUNet/DataAssembly_batch4nnunet_3channels.r"))
...
# nnUNet_plan_and_preprocess -t 014 -pl3d None -pl2d ExperimentPlanner2D_v21_RGB_nonorm
###############################################################################################