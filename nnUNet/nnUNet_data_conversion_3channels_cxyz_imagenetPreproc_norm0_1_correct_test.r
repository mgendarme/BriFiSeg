...
# load data
source(paste0(Unet_script_dir,"/nnUNet/DataAssembly_nnunet_3channels_cxyz_imagenetPreproc.r"))
...
for(i in 1:nrow(test_input)){
    for (j in 0:2) {
        temp_im_name = paste0(Test_Img_dir, "/", CELL, "_", make_correct_label(nrow(train_input) + i), "_000", j)
