...
pred_folder = paste0(nnunetpath, "/nnUNet_trained_models/nnUNet/2d/Task0", TASK, "_RWA_A549/nnUNetTrainerV2_unet_v3_noDeepSupervision_sn_adam__nnUNetPlansv2.1/imagesTs_predicted_ensemble")
label_folder = paste0(nnunetpath, "/nnUNet_raw/nnUNet_raw_data/Task0", TASK, "_RWA_A549/labelsTs")
...
Save_data = paste0(Save_dir, "/data_ts2")
